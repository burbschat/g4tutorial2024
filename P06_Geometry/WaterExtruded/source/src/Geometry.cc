...
//------------------------------------------------------------------------------
{
  ...
  auto solid_WaterBox
      = new G4Box{ "Solid_WaterBox", leng_X_WaterBox / 2.0,
                   leng_Y_WaterBox / 2.0, leng_Z_WaterBox / 2.0 };

  // Define the logical volume
  G4Material* materi_WaterBox = materi_Man->FindOrBuildMaterial ("G4_WATER");
  auto logVol_WaterBox = new G4LogicalVolume{
    solid_WaterBox, materi_WaterBox, "LogVol_WaterBox", 0, 0, 0
  };
  ...
  auto solid_WaterCont
      = new G4Box{ "Solid_WaterCont", leng_X_WaterCont / 2.0,
  ...
  auto logVol_WaterCont = new G4LogicalVolume{
    solid_WaterCont, materi_WaterCont, "LogVol_WaterCont", 0, 0, 0
  };
  ...
  new G4PVPlacement{ trans3D_LogV,
                     "PhysVol_WaterCont",
                     logVol_WaterCont,
                     physVol_World,
                     false,
