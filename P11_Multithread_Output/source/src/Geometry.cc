...
//------------------------------------------------------------------------------
{
  ...
  // Install 1st 'BGO Detector' copyNumber = 1000
  ...
  // Install 2nd 'BGO Detector' copyNumber = 2000
...
Geometry::ConstructSDandField ()
{
  ...
  // assign it to SDManager
  auto SDman = G4SDManager::GetSDMpointer ();
  SDman->AddNewDetector (aSV);
  SetSensitiveDetector ("LogVol_BGO", aSV);
}
