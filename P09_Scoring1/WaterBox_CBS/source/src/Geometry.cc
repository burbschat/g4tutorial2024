...
//------------------------------------------------------------------------------
{
  ...
  auto solid_Water = new G4Box ("Solid_Water", leng_X_Water / 2.0,
                                leng_Y_Water / 2.0, leng_Z_Water / 2.0);

  // Define logical volume
  G4Material* materi_Water = materi_Man->FindOrBuildMaterial ("G4_WATER");
  auto logVol_Water = new G4LogicalVolume (solid_Water, materi_Water,
                                           "LogVol_Water", 0, 0, 0);
