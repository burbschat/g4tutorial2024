...
//------------------------------------------------------------------------------
void
SensitiveVolume::Initialize (G4HCofThisEvent*)
{
...
//------------------------------------------------------------------------------
void
SensitiveVolume::EndOfEvent (G4HCofThisEvent*)
{
  G4cout << "*****==  EndOfEvent   " << G4endl;

  G4cout << " sum_eDep_1 = " << G4BestUnit (sum_eDep_1, "Energy")
         << " sum_stepLength_1 = " << G4BestUnit (sum_stepLength_1, "Length")
         << G4endl;
  G4cout << " sum_eDep_2 = " << G4BestUnit (sum_eDep_2, "Energy")
         << " sum_stepLength_2 = " << G4BestUnit (sum_stepLength_2, "Length")
         << G4endl;
}

//------------------------------------------------------------------------------
G4bool
SensitiveVolume::ProcessHits (G4Step* aStep, G4TouchableHistory*)
{
  ...
  G4cout << "        Track Number: " << idTrack
         << "  Particle: " << particleName << "  Energy: " << tEnergy
         << "  global time  " << globaltime << G4endl;
  ...
  G4cout << "        World(x,y,z): " << position_World.x () << ", "
         << position_World.y () << ", " << position_World.z ()
         << " copyNo : " << copyNo << "   Volume name " << volumeName
         << G4endl;
  ...
  if (copyNo == 1000)
    {
      sum_eDep_1 += edep;
      sum_stepLength_1 += stepLength;
    }
  if (copyNo == 2000)
    {
      sum_eDep_2 += edep;
      sum_stepLength_2 += stepLength;
    }
