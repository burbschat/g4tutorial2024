...
SensitiveVolume::ProcessHits (G4Step* aStep, G4TouchableHistory*)
{
  ...
  G4cout << "    eventID = " << eventID << "  Track ID =: " << idTrack
         << "  Particle =: " << particleName << " time = " << globalTime
         << G4endl;
  ...
  G4cout << "  replicaNo = " << replicaNo << "  replicaNo_1 = " << replicaNo_1
         << "  replicaNo_2 = " << replicaNo_2 << "  x = " << position_Worldx
         << "  ,   y = " << position_Worldy << " , z =  " << position_Worldz
         << G4endl;

  // store thsi Hit
  simdata[0].Fill (eventID, { replicaNo, replicaNo_1, replicaNo_2 },
                   { position_Worldx, position_Worldy, position_Worldz });
